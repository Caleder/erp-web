  ...
  methods: {
    ...
    async getCustomerPage () {
      ...
      this.customerList.forEach((customer) => {
        customer.beginBalanceDisplay = (customer.beginBalance / 100.0).toFixed(2)
      })
    ...
    async showEditDialog (customerId) {
      ...
      customer.beginReceivableAmountDisplay = (customer.beginReceivableAmount / 100.0).toFixed(2)
      customer.beginPrepaidAmountDisplay = (customer.beginPrepaidAmount / 100.0).toFixed(2)
